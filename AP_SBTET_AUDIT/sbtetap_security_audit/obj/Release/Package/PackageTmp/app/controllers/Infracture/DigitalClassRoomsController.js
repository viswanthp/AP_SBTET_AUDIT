define(['app'], function (app) {
    app.controller("DigitalClassRoomsController", function ($scope, $state, AdminService, $filter, $localStorage) {
        ...
        $scope.FilterDigitalClassRooms = function () {

            $scope.NoData = false;
            $scope.Data = false;
            $scope.Loading = true;
            var FilterDigitalClassRooms = AdminService.FilterDigitalClassRooms($scope.Region, $scope.District, $scope.CollegeType);
            FilterDigitalClassRooms.then(function (response) {
                try {
