define(['app'], function (app) {
    app.controller("NotificationsController", function ($scope, $state, $uibModal, $localStorage, AdminService) {
        ...
        $scope.Submit = function () {
            ...
            $scope.Loading = true;
            var adddistcoorcentre = AdminService.AddLatestNews($scope.Subject, $scope.Message, "Admin");
        ...
        $scope.UpdateLatestNews = function () {
            $scope.Loading = true;
            var adddistcoorcentre = AdminService.UpdateLatestNews($scope.EditData.LatestNewsSubject, $scope.EditData.LatestNewsText, $scope.EditData.Active, $scope.EditData.LatestNewsID);
            adddistcoorcentre.then(function (response) {
                try {
                    var res = JSON.parse(response);
                }
