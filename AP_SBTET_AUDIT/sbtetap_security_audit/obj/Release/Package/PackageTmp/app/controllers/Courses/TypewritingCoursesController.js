define(['app'], function (app) {
    app.controller("TypewritingCoursesController", function ($scope, $state, AdminService, $filter) {
        ...
        $scope.GetCollegeList = function () {
            ...
            var GetDistricts = AdminService.GetTwshCoursesList($scope.District);
            GetDistricts.then(function (response) {
                try {
