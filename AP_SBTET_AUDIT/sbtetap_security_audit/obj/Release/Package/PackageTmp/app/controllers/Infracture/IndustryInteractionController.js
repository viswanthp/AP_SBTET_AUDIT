define(['app'], function (app) {
    app.controller("IndustryInteractionController", function ($scope, $state, AdminService, $filter, $localStorage) {
        ...
        $scope.GetCollegeList = function () {
            ...
            var GetDistricts = AdminService.FilterIndustryInteract($scope.Region, $scope.District, $scope.CollegeType);
            GetDistricts.then(function (response) {
                try {
