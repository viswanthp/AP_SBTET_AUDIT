define(['app'], function (app) {
    app.controller("NotificationsController", function ($scope, $state, AdminService, $uibModal) {
        ...
        $scope.Add = function () {
            ...
            $scope.Loading = true;
            var adddistcoorcentre = AdminService.AddNotifications($scope.ImageText, $scope.NotificationFile, file.value.split("\\").pop(), $scope.NotificationDate, "Admin");
        ...
        $scope.UpdateNotifications = function () {
            $scope.Loading = true;
            var adddistcoorcentre = AdminService.UpdateNotifications($scope.EditData.NotificationText, $scope.EditData.NotificationFilePath, $scope.EditData.NotificationDate, $scope.EditData.Active, $scope.EditData.NotificationID);
            adddistcoorcentre.then(function (response) {
                try {
                    var res = JSON.parse(response);
                }
        ...
        $scope.DeleteNotificationsConfirm = function () {
            var GetNotificationsById = AdminService.DeleteNotificationById($scope.Id);
            GetNotificationsById.then(function (resp) {
                try {
                    var res = JSON.parse(resp);
                }
