define(['app'], function (app) {
    app.service("AdminService", function (DataAccessService) {
        ...
        this.GetAcademicCalenderById = function (AcademicCalenderID) {
            var paramObject = { "AcademicCalenderID": AcademicCalenderID };
        ...
        this.AddLatestNews = function (LatestNewsSubject, LatestNewsText,UserName) {
        ...
        this.UpdateLatestNews = function (LatestNewsSubject, LatestNewsText, Active,Id) {
            var paramObject = { "LatestNewsSubject": LatestNewsSubject, "LatestNewsText": LatestNewsText, "Active": Active, "Id": Id };
        ...
        this.UpdateCourses = function (CourseCode, CourseName, CourseShortDescription, CourseDetailedDescription, CoursePhoto, Active, CourseID, UserName,UpdateStatus) {
            var paramObject = {
                "CourseCode": CourseCode, "CourseName": CourseName, "CourseShortDescription": CourseShortDescription, "CourseDetailedDescription": CourseDetailedDescription
                , "CoursePhoto": CoursePhoto, "Active": Active, "CourseID": CourseID, "UserName": UserName, "UpdateStatus": UpdateStatus            };
        ...
        this.UpdateCorousels = function (SliderImageText, SliderImagePath, Active, Id) {
            var paramObject = { "SliderImageText": SliderImageText, "SliderImagePath": SliderImagePath, "Active": Active, "Id": Id };
        ...
        this.UpdateNotifications = function (NotificationText, NotificationFilePath, NotificationDate, Active, Id) {
            var paramObject = { "NotificationText": NotificationText, "NotificationFilePath": NotificationFilePath, "NotificationDate": NotificationDate,  "Active": Active, "Id": Id };
        ...
        this.UpdateSyllabus = function (SchemeID, CourseID,SyllabusText, SyllabusFilePath, SyllabusDate, Active, Id) {
            var paramObject = { "SchemeID": SchemeID, "CourseID": CourseID,  "SyllabusText": SyllabusText, "SyllabusFilePath": SyllabusFilePath, "SyllabusDate": SyllabusDate, "Active": Active, "Id": Id };
        ...
        this.UpdateQuestionPaper = function (SchemeID, CourseID, QuestionPaperText, QuestionPaperFilePath, QuestionPaperDate, Active, Id) {
            var paramObject = { "SchemeID": SchemeID, "CourseID": CourseID, "QuestionPaperText": QuestionPaperText, "QuestionPaperFilePath": QuestionPaperFilePath, "QuestionPaperDate": QuestionPaperDate, "Active": Active, "Id": Id };
        ...
        this.UpdateTimeTable = function (SchemeID, ExaminationYear, ExaminationSpell, TimeTableText, TimeTableFilePath, TimeTableDate, Active, Id) {
            var paramObject = { "SchemeID": SchemeID, "ExaminationYear": ExaminationYear, "ExaminationSpell": ExaminationSpell, "TimeTableText": TimeTableText, "TimeTableFilePath": TimeTableFilePath, "TimeTableDate": TimeTableDate, "Active": Active, "Id": Id };
