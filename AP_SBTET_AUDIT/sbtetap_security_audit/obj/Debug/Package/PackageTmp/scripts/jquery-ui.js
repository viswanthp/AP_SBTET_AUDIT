...
function Datepicker() {
    ...
    this.dpDiv = datepicker_bindHover($("<div style ='display: none!important;' id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")).css("display", "none");
}
	...
	_newInst: function(target, inline) {
		...
		return {id: id, input: target, // associated target
			...
			dpDiv: (!inline ? this.dpDiv : // presentation div
                datepicker_bindHover($("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")).css("display", "none"))};
	},
