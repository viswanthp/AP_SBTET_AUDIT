define(['app'], function (app) {
    app.controller("CourseSettingController", function ($scope, $state, AdminService, $filter, $localStorage, $uibModal) {
        ...
        $scope.Values = [{ "Id": true, "Name": "Yes" }, { "Id": false, "Name": "No" }]
        ...
        $scope.WebsiteValues = [{ "Id": 1, "value": "YES" }, { "Id": "NO", "value": 0 }]
        ...
        $scope.Add = function () {
            ...
            if ($scope.IsDisplayinWebsite == "" || $scope.IsDisplayinWebsite == null || $scope.IsDisplayinWebsite == undefined) {
                alert("Enter Is Display in Website");
                return;
            }
            $scope.Loading = true;
            var adddistcoorcentre = AdminService.AddCourse($scope.CourseCode, $scope.CourseName, $scope.CourseShortDescription, $scope.CourseLongDescription, $scope.userPhoto1, $scope.IsDisplayinWebsite, "Admin");
        ...
        $scope.UpdateCourses = function () {
            ...
            var adddistcoorcentre = AdminService.UpdateCourses($scope.EditData.CourseCode, $scope.EditData.CourseName, $scope.EditData.CourseShortDescription, $scope.EditData.CourseDetailedDescription, $scope.EditData.CoursePhoto, $scope.EditData.Active, $scope.EditData.CourseID, $scope.EditData.IsDisplayinWebsite,  "Admin", $scope.update);
