define(['app'], function (app) {
    app.controller("CollegeJournalController", function ($scope, $localStorage, $state, AdminService, $filter) {
        ...
        $scope.UpdateJournal = function (CollegeLabID) {
            if ($scope.CollegeJournal1 == undefined || $scope.CollegeJournal1 == "" || $scope.CollegeJournal1 == null) {
                //  $scope.EditData.SliderImagePath = "";
                var FileUpload = '0';
                var FileName = ""
            } else {
                $scope.JournalPath = $scope.CollegeJournal1
                var FileUpload = '1';
            ...
            if ($scope.JournalPath == null || $scope.JournalPath == "" || $scope.JournalPath == undefined) {
                alert("Please Upload Journal");
                return;
            }
        ...
        $scope.DeleteJournalById = function (JournalID) {
            ...
            var journal = AdminService.DeleteCollegeJournal(objs);
            journal.then(function (response) {
                try {
                    var res = JSON.parse(response);
                }
                catch (err) {
