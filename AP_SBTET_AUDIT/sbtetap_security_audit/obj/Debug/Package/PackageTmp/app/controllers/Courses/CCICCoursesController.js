define(['app'], function (app) {
    app.controller("CCICCoursesController", function ($scope, $state, AdminService, $filter) {
        ...
        $scope.GetCollegeList = function () {
            ...
            var GetDistricts = AdminService.GetCCICCoursesList($scope.District);
            GetDistricts.then(function (response) {
                try {
