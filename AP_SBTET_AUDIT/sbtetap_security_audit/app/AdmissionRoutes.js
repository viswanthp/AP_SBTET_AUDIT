define([], function () {
    ...
    return {
        ...
        routes: {
            ...
            'Dashboard.SubDashboard.Gallery': {
                url: "/Gallery",
                templateUrl: 'app/views/Gallery.html',
                dependencies: ['controllers/GalleryController', 'services/AdminService/AdminService']
            },
            ...
            'PublishWebsite': {
                url: "/PublishWebsite",
                templateUrl: 'app/views/PublishWebsite.html',
                dependencies: ['controllers/PublishWebsiteController', 'services/SystemAdministrator/SystemUserService', 'services/AdminService/AdminService']
            },

            'CommingSoon': {
                url: "/CommingSoon",
                templateUrl: 'app/views/CommingSoon.html',
                dependencies: ['controllers/CommingSoonController', 'services/SystemAdministrator/SystemUserService', 'services/AdminService/AdminService']
            },
            ...
            'Dashboard.SubDashboard.CollegeWiseBranches': {
                url: "/CollegeWiseBranches",
                templateUrl: 'app/views/MasterPages/CollegeWiseBranches.html',
                dependencies: ['controllers/MasterPages/CollegeWiseBranchesController', 'services/AdminService/AdminService']
            },

            'Dashboard.SubDashboard.Counts': {
                url: "/Counts",
                templateUrl: 'app/views/MasterPages/Counts.html',
                dependencies: ['controllers/MasterPages/CountsController', 'services/AdminService/AdminService']
            },

            'Dashboard.SubDashboard.ResetPassword': {
                url: "/ResetPassword",
                templateUrl: 'app/views/ResetPassword.html',
                dependencies: ['controllers/ResetPasswordController', 'services/AdminService/AdminService', 'services/SystemAdministrator/ChangePasswordService']
            },
            

            'Dashboard.SubDashboard.ChangePassword': {
                url: "/ChangePassword",
                templateUrl: 'app/views/ChangePassword.html',
                dependencies: ['controllers/ChangePasswordController', 'services/AdminService/AdminService', 'services/SystemAdministrator/ChangePasswordService']
            },
            ...
            'Dashboard.SubDashboard.Links': {
                url: "/Links",
                templateUrl: 'app/views/MasterPages/Links.html',
                dependencies: ['controllers/MasterPages/LinksController', 'services/AdminService/AdminService']
            },
            'Dashboard.SubDashboard.PopupSettings': {
                url: "/PopupSettings",
                templateUrl: 'app/views/MasterPages/PopupSettings.html',
                dependencies: ['controllers/MasterPages/PopupSettingsController', 'services/AdminService/AdminService']
            },

            

            'Dashboard.SubDashboard.OtherLinks': {
                url: "/OtherLinks",
                templateUrl: 'app/views/CollegePages/OtherLinks.html',
                dependencies: ['controllers/CollegePages/OtherLinksController', 'services/AdminService/AdminService']
            },
            ...
            'index.DiplomaProcess': {
                url: "/DiplomaProcess",
                templateUrl: 'app/views/DiplomaProcess.html',
                dependencies: ['controllers/DiplomaProcessController', 'services/AdminService/AdminService']
            },
            ...
            'index.AboutSbtetVideo': {
                url: "/AboutSbtetVideo",
                templateUrl: 'app/views/AboutSbtetVideo.html',
                dependencies: ['controllers/AboutSbtetVideoController', 'services/AdminService/AdminService']
            },
