define(['app'], function (app) {
    app.controller("CollegePlacementsController", function ($scope, $localStorage, $state, AdminService, $filter) {
        ...
        $scope.DeletePlacementsById = function (CollegePlacementID) {


            var objs = {
                "CollegePlacementID": CollegePlacementID,

            }

            var delcollegeplacement = AdminService.DeleteCollegePlacement(objs);
            delcollegeplacement.then(function (response) {
                try {
                    var res = JSON.parse(response);
                }
                catch (err) {
