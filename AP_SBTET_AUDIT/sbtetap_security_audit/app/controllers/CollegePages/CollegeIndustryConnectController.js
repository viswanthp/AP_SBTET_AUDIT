define(['app'], function (app) {
    app.controller("CollegeIndustryConnectControlles", function ($scope, $localStorage, $state, AdminService, $filter) {
        ...
        $scope.DeleteIndustryConnectById = function (IndustryConnectID) {


            var objs = {
                "IndustryConnectID": IndustryConnectID,

            }

            var delindustryconnect = AdminService.DeleteIndustryConnect(objs);
            delindustryconnect.then(function (response) {
                try {
                    var res = JSON.parse(response);
                }
                catch (err) {
